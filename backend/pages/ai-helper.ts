...
export async function sendRecipeRequest(req: recipeRequest): Promise<Recipe> {
    ...
    messages: [
      {
        ...
        content: `Du erhälst ein dictionary, welches eine Liste von Zutaten enthält. 
		  ...
		  Das antwort dictionary hat also die struktur {"ingredients": [{"ingredient": "zutat", "amount": menge als zahl, "unit": "einheit als ml, gr oder st"}], "instruction": "beschreibung",
